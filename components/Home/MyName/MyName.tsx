  ...
  return (
    ...
    >
      ...
      >
        ...
        digital experiences in Web development and Graphic Design. My current area of focus is in the <span className="text-AAsecondary">web domain</span>,
        ...
        <span className="text-AAsecondary">Responsive Designs</span>  and{" "}
        <span className="text-AAsecondary">Graphic Designs </span>. 
